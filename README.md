...
3. Run `npm run setup` in order to install dependencies and clean the git repo. We auto-detect `yarn` for installing packages by default, if you wish to force `npm` usage do: `USE_YARN=false npm run setup`.
